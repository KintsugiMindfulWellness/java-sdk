...
import com.kintsugi.client.openapi.model.FeedbackFeedbackRequestPredictionValidBinaryString;
import com.kintsugi.client.openapi.model.FeedbackRequestGAD7;
import com.kintsugi.client.openapi.model.FeedbackRequestPHQ2;
import com.kintsugi.client.openapi.model.FeedbackRequestPHQ9;
...
public class FeedbackApi {
  ...
  /**
   * Patient Feedback for GAD-7
   * Submits patient feedback for GAD-7
   * @param xAPIKey API Key to be checked (required)
   * @param data request body (required)
   * @throws ApiException if fails to make API call
   */
  public void feedbackGad7Patch(String xAPIKey, FeedbackRequestGAD7 data) throws ApiException {
    Object localVarPostBody = data;
    
    // verify the required parameter 'xAPIKey' is set
    if (xAPIKey == null) {
      throw new ApiException(400, "Missing the required parameter 'xAPIKey' when calling feedbackGad7Patch");
    }
    
    // verify the required parameter 'data' is set
    if (data == null) {
      throw new ApiException(400, "Missing the required parameter 'data' when calling feedbackGad7Patch");
    }
    
    // create path and map variables
    String localVarPath = "/feedback/gad/7".replaceAll("\\{format\\}","json");
